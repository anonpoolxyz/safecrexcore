    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Safecrex Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Safecrex Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  safecrex-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Safecrex in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SFCX, 0.1 SFCX, 1 SFCX and 10 SFCX -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Safecrex Core is shutting down...") + "<br /><br />" +
